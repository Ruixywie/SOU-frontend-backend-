<template>
  <div class="loader-container" v-if="visible"> <!-- 使用 v-if 控制显示 -->
    <div class="loader">
    ...
    <div class="loading-words">
      <p>正在加载</p>
      <div class="words">
        <span class="word">原神</span>
        <span class="word">图片</span> <!-- 第一个显示的位置 -->
        <span class="word">表格</span>
        <span class="word">按钮</span>
        <span class="word">原神</span>
      </div>
    </div>
  </div>
